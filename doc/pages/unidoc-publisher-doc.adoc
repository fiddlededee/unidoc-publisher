...
<6> Adding logo to AST if necessary
<7> Converting AST to FODT
<8> Checking spelling if necessary
<9> Outputting HTML if necessary
<10> Outputting AST as YAML if necessary
<11> Outputting FODT
